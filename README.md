...
2. Let it scan your local Claude Code session data.
3. Review the dashboard once the charts appear.
4. If asked to choose a folder, point it to the place where your Claude Code session files are stored.
5. Keep the app open while you work if you want live updates.
...
5. Keep the app open while you view your dashboard
...
4. Open the app
5. Review your Claude Code data
6. Keep using Claude Code as normal
7. Return to the dashboard when you want a fresh view
...
5. Wait for your session data to load
6. Read the charts and totals on screen